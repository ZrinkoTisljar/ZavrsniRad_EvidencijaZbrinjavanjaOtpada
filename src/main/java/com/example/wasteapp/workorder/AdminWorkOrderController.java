...
public class AdminWorkOrderController {
    ...
    /**
     * ADMIN: Planiranje odvoza s odabranim datumom
     * */
    @PatchMapping("/{id}/schedule")
    public WorkOrderResponse scheduled(
            @PathVariable Long id,
            @RequestParam("date") String dateStr // Očekuje datum iz Reacta
    ) {
        ...
        wo.setStatus(WorkOrderStatus.SCHEDULED);
        // Pretvara tekstualni datum iz Reacta u Java LocalDateTime
        wo.setScheduledFor(LocalDateTime.parse(dateStr));
